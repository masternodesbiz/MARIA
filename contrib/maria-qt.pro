...
RESOURCES += src/qt/maria.qrc src/qt/maria_locale.qrc

TRANSLATIONS += src/qt/locale/maria_bg.ts \
                src/qt/locale/maria_de.ts \
                src/qt/locale/maria_en.ts \
                src/qt/locale/maria_es.ts \
                src/qt/locale/maria_fi.ts \
                src/qt/locale/maria_fr.ts \
                src/qt/locale/maria_it.ts \
                src/qt/locale/maria_ja.ts \
                src/qt/locale/maria_pl.ts \
                src/qt/locale/maria_pt.ts \
                src/qt/locale/maria_ru.ts \
                src/qt/locale/maria_sk.ts \
                src/qt/locale/maria_sv.ts \
                src/qt/locale/maria_vi.ts \
                src/qt/locale/maria_zh_CN.ts \
                src/qt/locale/maria_zh_TW.ts
