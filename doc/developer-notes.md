...
Run with the `-testnet` option to run with "play MARIAs (tMARIA)" on the test network, if you
...
([`valgrind.supp`](https://github.com/maria-project/maria/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates MARIAs (if wallet is enabled).
...
- src/chiabls
  - Upstream at https://github.com/MARIA-Project/bls-signatures/ ; actively maintained by Core contributors, deviates from upstream https://github.com/Chia-Network/bls-signatures/
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:hostmaria/mariacoin.git
