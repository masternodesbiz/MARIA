...
with certain assembly code from MARIA Core's code. See [developer notes on sanitizers](https://github.com/hostmaria/mariacoin/blob/master/doc/developer-notes.md#sanitizers)
