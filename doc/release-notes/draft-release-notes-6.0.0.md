...
MARIA Core version *version* is now available from:  <https://github.com/maria-project/maria/releases>
...
A ProTx either creates a 10000-MARIA collateral as tx output, or includes a reference to an unspent 10000-MARIA utxo on chain (and a proof of ownership).
See PR [#2267](https://github.com/hostmaria/mariacoin/pull/2267) for more information.
...
* `protx_register_fund`
    ...
    Creates, funds and sends a ProTx to the network. The resulting transaction will move 10000 MARIA
...
With this rule, a new opcode (`0xd2`) is introduced (see PR [#2275](https://github.com/hostmaria/mariacoin/pull/2275)).
