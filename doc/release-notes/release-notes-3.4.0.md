MARIA Core version *3.4.0* is now available from:  <https://github.com/maria-project/maria/releases>
...
### Wallet
 ...
 - #971 `bbeabc4d63` [Wallet][zMARIA] zc public spend parse crash in wallet startup. (furszy)
