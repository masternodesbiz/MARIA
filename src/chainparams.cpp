...
{
    const char* pszTimestamp = "2022 Host Maria - Maria Coin";
...
static MapCheckpoints mapCheckpoints = {
    { 0, uint256S("0000040cb60b26f13ffcd2f692d679e172da34096041efe215d8c50cd65dd9f9")},
	{ 250, uint256S("c27c5a5374de5c702e02b199b1a30fda040e5f15f9ac096fe1912c44493615ef")},
	{ 2000, uint256S("7341726c7323423d4dfce3e3167f9a2f73efc40e1b19ce6400b0a00d29cdd9f1")},
	{ 100001, uint256S("308ae3e99155c07c249c64189fc8b762cd2512c3209b6ce981dcfdfab7ca04c8")},
	{ 200001, uint256S("7b189899c4a81f3050e3becd73e36af1320026fee0828fd0d74b98cb318d35af")},
	{ 260779, uint256S("382673d56402c76d60b9a4a306f48798cbf81341b24a4fbb1a84bbe506d0961e")},
};

static const CCheckpointData data = {
    &mapCheckpoints,
    1678686675, // * UNIX timestamp of last checkpoint block
    541699,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000040cb60b26f13ffcd2f692d679e172da34096041efe215d8c50cd65dd9f9"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e82501aa4f898173ca938fef4d080f25969109efd7b790fe323bcff9f16dc04"));
        ...
        // spork keys
        consensus.strSporkPubKey = "046e97e02e488c085c15173c49b9bb1df32966ca60ddc535baba0e3775c55f305c1f1736dea5389310ba89c2a0875512717faa1ec92d2293e1fad15aa36993bf89";
        consensus.strSporkPubKeyOld = "0415fe37387ea3d50f799a5c34df915a0c6e23db90a73010e6bb3ed345ec47ba689a365443c4bdea0e0ab1290804321449f319aba109adf74b1f2d7bcfba55a96c";
        consensus.nTime_EnforceNewSporkKey = 1680889926;    //!> December 21, 2020 01:00:00 AM GMT
        consensus.nTime_RejectOldSporkKey = 1680889925;     //!> March 1, 2021 01:00:00 AM GMT
        ...
        consensus.ZC_HeightStart = 9999999;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight          = 331400;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].hashActivationBlock =
                uint256S("0x8b325e9af660b2d67bd907b559bc93072b8a22ed1297eb1b0d80002b7bf7e650");
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].hashActivationBlock =
                uint256S("0x00");
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].hashActivationBlock =
                uint256S("0xcb8e1cd25b79262e9291f7621673baff1c2470cdc1b8ffbf8bf16a1c23c70b2b");
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].hashActivationBlock =
                uint256S("0x863cbb60e97ade026de43e12ca2e17cd6c3dccafbf1c4f27bac9cdfcfc162c04");
        ...
        vSeeds.emplace_back("199.127.140.224", true);     // Primary DNS Seeder
        vSeeds.emplace_back("199.127.140.225", true);    // Secondary DNS Seeder
        vSeeds.emplace_back("199.127.140.235", true);     // Teritary DNS Seeder
        vSeeds.emplace_back("199.127.140.236", true);
        vSeeds.emplace_back("dnseed.mariaseed.com", true);
        vSeeds.emplace_back("dnseed.mariaseed1.com", true);
        vSeeds.emplace_back("dnseed.mariaseed2.com", true);
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "mariaks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("maria-testnet.seed.mariacoin.com", true);
        vSeeds.emplace_back("maria-testnet.seed2.mariacoin.com", true);
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "mariaktestsapling";
