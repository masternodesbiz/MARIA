...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(mMARIA);
    unitlist.append(uMARIA);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit, bool isZmaria)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMARIA)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZMARIA);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMARIA)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZMARIA));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
