...
SettingsFaqWidget::SettingsFaqWidget(MARIAGUI* parent, MNModel* mnModel) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableMARIA,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableMARIA,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableMARIA,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableMARIA,
              ui->pushButton_Stake,
    ...
    QString unspendableMARIAContent = formatFAQContent(
        formatFAQParagraph(
    ...
    ui->labelContent_UnspendableMARIA->setText(unspendableMARIAContent);
        ...
        formatFAQParagraph(
            tr("A masternode is a computer running a full node %1 wallet with a "
               ...
               "regularly. These services include:")
                .arg(PACKAGE_NAME)
                .arg(GUIUtil::formatBalance(mnModel->getMNCollateralRequiredAmount(), BitcoinUnits::MARIA)) +
    ...
    connect(ui->pushButton_UnspendableMARIA, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableMARIA);});
