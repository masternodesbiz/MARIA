...
public:
    ...
    /// Get 10000 MARIA output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CMariaStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
