...
"""Verify that starting maria with -h works as expected."""
...
class HelpTest(MariaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start maria with -? for help text")
        ...
        self.log.info("Start maria with -version for version information")
