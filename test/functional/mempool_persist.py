...
By default, mariad will dump mempool on shutdown and
...
class MempoolPersistTest(MariaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mariad from writing mempool.dat to disk. Verify that `savemempool` fails")
