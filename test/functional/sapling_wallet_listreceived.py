...
class ListReceivedTest (MariaTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 MARIA.
        ...
        # Send 1 MARIA to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 MARIA sending them all (fee is 0.1 MARIA)
        ...
        # Confirm transaction (2 MARIA from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 MARIA, send 0.6 MARIA + 0.05 MARIA fee
