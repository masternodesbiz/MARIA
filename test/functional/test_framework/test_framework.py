...
class MariaTestFramework():
    ...
    """
    Create a ProReg tx, which references an 100 MARIA UTXO as collateral.
...
class MariaDMNTestFramework(MariaTestFramework):
...
class MariaTier2TestFramework(MariaTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [["-nuparams=v5_shield:249", "-nuparams=MARIA_v5.5:250", "-nuparams=v6_evo:250", "-whitelist=127.0.0.1"]] * self.num_nodes
